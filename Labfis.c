...
LiquidCrystal display1(11,10,7,6,5,4);
LiquidCrystal display2(9,8,7,6,5,4);
...
void setup(){
     ...
     display2.setCursor(0,0);
          display1.print("Denissa P.A.");
     display2.setCursor(0,1);
          display1.print("Sindya");
...
if(titik1==0 && titik2==0){display2.print("Yang bener aja");}
    ...
    display1.print("kecepatan 1:");
    display1.print(kecepatan1,1);
    display1.print("m/s");

    display1.setCursor(0, 1); 

    display1.print("kecepatan 2:");
    ...
    display2.print("Perceoatan :");
    display2.print(percepatan,1);
    display2.print("m/s^2");

    display2.setCursor(0, 1); 

    display2.print("selesai");
